...
public class NotifyUtil {
     ...
     * @param ticker
     */
    public void setCompatBuilder(PendingIntent pendingIntent, @DrawableRes int smallIcon, String ticker,
...
//                requestCode, intent, FLAG);
     ...
     * @param content
     */
    public void notify_normal_single(PendingIntent pendingIntent, int smallIcon,
    ...
    public void notify_normail_moreline(PendingIntent pendingIntent, int smallIcon, String ticker,
        ...
        if (sdk < Build.VERSION_CODES.JELLY_BEAN) {
            notify_normal_single(pendingIntent, smallIcon, ticker, title, content, sound, vibrate, lights);
